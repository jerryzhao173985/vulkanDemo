...
namespace lpzrobots {
    ...
    */
    ...
    public:
        ...
        virtual vsg::ref_ptr<vsg::Node> getVSGNode() = 0;
    ...
    public:
        ...
        virtual void update();
        virtual vsg::ref_ptr<vsg::Node> getVSGNode();

        virtual void setMass(double mass, bool density = false);

    protected:
        vsg::ref_ptr<vsg::Node> vsgPlane;
    };
    ...
    protected:
        vsg::ref_ptr<vsg::Node> vsgSphere;
        double radius;
    };
