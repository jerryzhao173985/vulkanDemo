...
namespace lpzrobots {
    ...
    // Global variable for velocity violations
    ...
    */
    ...
    /** OSGPrimitive equivalent for VSG
        Interface class for graphical primitives that can be drawn by VSG.
    */
    class VSGPrimitive : public vsg::Inherit<vsg::Node, VSGPrimitive> {
    public:
        virtual ~VSGPrimitive() {}

        /// Returns the VSG node representing the primitive
        virtual vsg::ref_ptr<vsg::Node> getNode() const = 0;

        /// Sets the color of the primitive
        virtual void setColor(const Color& color) = 0;

        /// Sets the texture of the primitive
